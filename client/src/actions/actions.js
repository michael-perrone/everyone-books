...
export const REMOVE_CREATE_STATE = "REMOVE_CREATE_STATE";
...
export const RESTAURANT_SEND_HIT = "RESTAURANT_SEND_HIT";
export const BOOKING_COLUMNS_ENTERED = "BOOKING_COLUMNS_ENTERED";