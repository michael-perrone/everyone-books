    ...
    return (
        ...
        <div id={styles.viewBookingContainer}>
            ...
            <div id={styles.leftContainer}>
                ...
                <button onClick={deleteGroup} style={{backgroundColor: "salmon", height: "35px", width: "120px", position: "absolute", bottom: "40px", color: "black", marginTop: "80px", fontWeight: "bold", boxShadow: "0px 0px 2px #f9e9f9", border: "none"}}>{!deleting ? "Delete Group" : "Confirm"}</button>
            </div>
