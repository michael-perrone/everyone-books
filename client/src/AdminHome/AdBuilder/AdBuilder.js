...
//                     <div>
//                     <p style={{marginTop: "30px", color: "black"}}>Step One: Choose Target Audience</p>
//                     <select onChange={toSetTargetAudience} style={{height: "24px", width: "250px", backgroundColor: "#f9e9f9", color: "black", marginTop: "10px", paddingLeft: "4px", boxShadow: "0px 0px 4px black", border: "none"}}>
//                         <option> </option>
...
function AdBuilder() {
    return (
        <div style={{backgroundColor: "#f9e9f9", height: "100vh"}}>
