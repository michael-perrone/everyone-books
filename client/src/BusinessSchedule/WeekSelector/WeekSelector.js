...
const WeekSelector = (props) => {
   ...
   function addYear() {
    ...
    return (
        ...
        <div id={styles.days}>
           <div><p style={{marginBottom: '8px'}}>Sun</p>{sunday.map(element => <p style={{ height: element === " " ? "18px": "", backgroundColor: dayNum === element.day && (element.type !== "premonth" && element.type !== "postmonth") ? "#f9e9f9": "", color: dayNum === element.day && (element.type !== "premonth" && element.type !== "postmonth") ? "black" : "" }} onClick={getDate(element.day, element.type)} id={element.type === "premonth" || element.type === "postmonth" ? styles.preMonthPostMonth : styles.regDay} className={styles.day}>{element.day}</p>)}</div>
           <div><p style={{marginBottom: '8px'}}>Mon</p>{monday.map(element => <p style={{ height: element === " " ? "18px": "", backgroundColor: dayNum === element.day && (element.type !== "premonth" && element.type !== "postmonth") ? "#f9e9f9": "", color: dayNum === element.day && (element.type !== "premonth" && element.type !== "postmonth") ? "black" : ""}} onClick={getDate(element.day, element.type)} id={element.type === "premonth" || element.type === "postmonth" ? styles.preMonthPostMonth : styles.regDay} className={styles.day}>{element.day}</p>)}</div>
           <div><p style={{marginBottom: '8px'}}>Tue</p>{tuesday.map(element => <p style={{ height: element === " " ? "18px": "", backgroundColor: dayNum === element.day && (element.type !== "premonth" && element.type !== "postmonth") ? "#f9e9f9": "", color: dayNum === element.day && (element.type !== "premonth" && element.type !== "postmonth") ? "black" : ""}} onClick={getDate(element.day, element.type)} id={element.type === "premonth" || element.type === "postmonth" ? styles.preMonthPostMonth : styles.regDay} className={styles.day}>{element.day}</p>)}</div>
           <div><p style={{marginBottom: '8px'}}>Wed</p>{wednesday.map(element => <p style={{ height: element === " " ? "18px": "", backgroundColor: dayNum === element.day && (element.type !== "premonth" && element.type !== "postmonth") ? "#f9e9f9": "", color: dayNum === element.day && (element.type !== "premonth" && element.type !== "postmonth") ? "black" : ""}} onClick={getDate(element.day, element.type)} id={element.type === "premonth" || element.type === "postmonth" ? styles.preMonthPostMonth : styles.regDay} className={styles.day}>{element.day}</p>)}</div>
           <div><p style={{marginBottom: '8px'}}>Thu</p>{thursday.map(element => <p style={{ height: element === " " ? "18px": "", backgroundColor: dayNum === element.day && (element.type !== "premonth" && element.type !== "postmonth") ? "#f9e9f9": "", color: dayNum === element.day && (element.type !== "premonth" && element.type !== "postmonth") ? "black" : ""}} onClick={getDate(element.day, element.type)} id={element.type === "premonth" || element.type === "postmonth" ? styles.preMonthPostMonth : styles.regDay} className={styles.day}>{element.day}</p>)}</div>
           <div><p style={{marginBottom: '8px'}}>Fri</p>{friday.map(element => <p style={{ height: element === " " ? "18px": "", backgroundColor: dayNum === element.day && (element.type !== "premonth" && element.type !== "postmonth") ? "#f9e9f9": "", color: dayNum === element.day && (element.type !== "premonth" && element.type !== "postmonth") ? "black" : ""}} onClick={getDate(element.day, element.type)} id={element.type === "premonth" || element.type === "postmonth" ? styles.preMonthPostMonth : styles.regDay} className={styles.day}>{element.day}</p>)}</div>
           <div><p style={{marginBottom: '8px'}}>Sat</p>{saturday.map(element => <p style={{ height: element === " " ? "18px": "", backgroundColor: dayNum === element.day && (element.type !== "premonth" && element.type !== "postmonth") ? "#f9e9f9": "", color: dayNum === element.day && (element.type !== "premonth" && element.type !== "postmonth") ? "black" : ""}} onClick={getDate(element.day, element.type)} id={element.type === "premonth" || element.type === "postmonth" ? styles.preMonthPostMonth : styles.regDay} className={styles.day}>{element.day}</p>)}</div>
        </div>
    </div>
    )
}
